...
class FSDPVLLMShardingManager(BaseShardingManager):
    ...
    def load_vllm_and_sync_weights(self):
        ...
        # Reset mm cache so sender (renderer) and receiver (engine) caches stay
        # in sync after sleep/wake. Without this vLLM 0.18 hits an assert when
        # the renderer thinks an image is cached but the receiver cache was
